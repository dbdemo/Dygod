package db.com.dygod.module.main.Xvdieo;
 ...
 */
public class XvdieoFragments extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener , View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(xvdieoView!=null){
            isPrepared = false;
            System.out.println("欧美onCreateView===不为空");
            return xvdieoView;
        }
        xvdieoView = View.inflate(mContext, R.layout.fragment_xvdieo, null);
        initView(xvdieoView);
        System.out.println("欧美onCreateView");
        isPrepared = true;
        return xvdieoView;
    }
    ...
    private void initData() {
        ...
        mainDataServant.getNewsData(UrlConstant.getInstance().getXvdieoUrlCache(),false, true, currentPageIndex, mNetWorkListener);
    ...
    private RecommendNewsRecyAdapter.RecyclerViewItemClickListener mItemClickListener = new RecommendNewsRecyAdapter.RecyclerViewItemClickListener() {
        ...
        public void onItemClick(View view, int position) {
            if (mDialog == null) {
                mDialog = new StyleDialog(XvdieoFragments.this.getContext(), "正在获取数据");
            }
            mDialog.show();
            //根据地址获取电影信息
            ...
            movieInfoServant.getMovieInfoData(UrlConstant.mainUrl+data.get(position).getTitlinkle(), new NetWorkListener<MovieInfoEntity>() {
                ...
                public void successful(MovieInfoEntity movieInfoEntity) {
                    mDialog.dismiss();
                    MovieInfoActivity.start(XvdieoFragments.this.getContext(), movieInfoEntity);
                }
    ...
    public void getNetData() {
        GetClassifyServant mainDataServant = new GetClassifyServant();
        mainDataServant.getNewsData(UrlConstant.getInstance().getXvdieoUrlCache(),true, false, currentPageIndex, mNetWorkListener);
    }
