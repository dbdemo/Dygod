package db.com.dyhome.module.main.JapanOrSouth;
 ...
 * 日韩电视
 */
public class JapanOrSouthTvFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener , View.OnClickListener {
    ...
    private void initCache(){
        ...
        mainDataServant.getNewsData(UrlConstant.getInstance().getJndyUrlCachetv(),false, true, currentPageIndex, mNetWorkListener);
    ...
    private RecommendNewsRecyAdapter.RecyclerViewItemClickListener mItemClickListener = new RecommendNewsRecyAdapter.RecyclerViewItemClickListener() {
        ...
        public void onItemClick(View view, int position) {
            if (mDialog == null) {
                mDialog = new StyleDialog(JapanOrSouthTvFragment.this.getContext(), "正在获取数据");
            }
            mDialog.show();
            //根据地址获取电影信息
            ...
            movieInfoServant.getMovieInfoData(UrlConstant.mainUrl+data.get(position).getTitlinkle(), new NetWorkListener<MovieInfoEntity>() {
                ...
                public void successful(MovieInfoEntity movieInfoEntity) {
                    mDialog.dismiss();
                    MovieInfoActivity.start(JapanOrSouthTvFragment.this.getContext(), movieInfoEntity);
                }
    ...
    public void getNetData() {
        GetClassifyServant mainDataServant = new GetClassifyServant();
        mainDataServant.getNewsData(UrlConstant.getInstance().getJndyUrlCachetv(),true, false, currentPageIndex, mNetWorkListener);
    }
