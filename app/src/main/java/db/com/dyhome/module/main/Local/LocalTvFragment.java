package db.com.dyhome.module.main.Local;
...
public class LocalTvFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener{
    ...
    private void initCache(){
        ...
        mainDataServant.getNewsData(UrlConstant.getInstance().getLocalUrlCachetv(), false, true, currentPageIndex, mNetWorkListener);
        ...
        public void onItemClick(View view, int position) {
            ...
            movieInfoServant.getMovieInfoData(UrlConstant.mainUrl + data.get(position).getTitlinkle(), new NetWorkListener<MovieInfoEntity>() {
                ...
                public void successful(MovieInfoEntity movieInfoEntity) {
                    mDialog.dismiss();
                    MovieInfoActivity.start(LocalTvFragment.this.getContext(), movieInfoEntity);
                }
    ...
    public void getNetData() {
        GetClassifyServant mainDataServant = new GetClassifyServant();
        mainDataServant.getNewsData(UrlConstant.getInstance().getLocalUrlCachetv(), true, false, currentPageIndex, mNetWorkListener);
    }
